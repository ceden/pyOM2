...
class pyOM_gui(Tkinter.Frame,pyOM_ave):
   ...
   def __init__(self):
     ...
     if  M.my_pe == 0:
       ...
       self.time_step_list.insert(Tkinter.END,'Number of PEs : %i \n' % M.n_pes )
       ...
       self.image_button1 = Tkinter.PhotoImage(master=Toolbar, file=
                     os.path.join(matplotlib.rcParams['datapath'], 'images', 'forward.png') )     
       self.image_button2 = Tkinter.PhotoImage(master=Toolbar, file=
                    os.path.join(matplotlib.rcParams['datapath'], 'images', 'hand.png')  )
