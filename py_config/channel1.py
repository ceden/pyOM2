...
GRID_POINTS        = 64      # number of grid points in lateral direction
GRID_POINTS_Z      = 20      # number of grid points in lateral direction
EDDY_LENGTH_SCALES = 2 # number of eddies in domain

if 1: # meso-scale regime
  Ro  = 0.05
  Ek  = 0.001
  CFL = 0.02    # CFL number
...
if __name__ == "__main__": 
    #channel1().mainloop( snapint = 86400.0)
    channel1().run( snapint = 86400.0, runlen = 365*86400.)
