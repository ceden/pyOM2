...
!=======================================================================
    ...
    real*8  :: rsold,alpha,rsnew,dot_3D,absmax_3D,fxa
...
!----------------------------------------------------------------------
        ...
        fxa=dot_3D(is_pe-onx,ie_pe+onx,js_pe-onx,je_pe+onx,nz,p,Ap)
        if (fxa == 0d0) goto 101
        alpha=rsold/fxa!dot_3D(is_pe-onx,ie_pe+onx,js_pe-onx,je_pe+onx,nz,p,Ap)
