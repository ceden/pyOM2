...
!=======================================================================
     ...
     if (enable_idemix) then
       if (enable_idemix3) then
          ...
          write(io,err=10) G_s(is:ie,js:je,:,tau),G_s(is:ie,js:je,:,taum1)
          write(io,err=10) F_d(is:ie,js:je,:,tau),F_d(is:ie,js:je,:,taum1)
          write(io,err=10) G_d(is:ie,js:je,:,tau),G_d(is:ie,js:je,:,taum1)
          write(io,err=10) O_s(is:ie,js:je,:,tau),O_s(is:ie,js:je,:,taum1)
          write(io,err=10) P_s(is:ie,js:je,:,tau),P_s(is:ie,js:je,:,taum1)
          write(io,err=10) O_d(is:ie,js:je,:,tau),O_d(is:ie,js:je,:,taum1)
          write(io,err=10) P_d(is:ie,js:je,:,tau),P_d(is:ie,js:je,:,taum1)   
       else
          write(io,err=10) E_iw(is:ie,js:je,:,tau),E_iw(is:ie,js:je,:,taum1)
          write(io,err=10) dE_iw(is:ie,js:je,:,tau),dE_iw(is:ie,js:je,:,taum1)
       endif
       if (enable_leewaves) then
         write(io,err=10) flux_lee_tot(is:ie,js:je),inv_fr(is:ie,js:je)
         write(io,err=10) stress_lee_u(is:ie,js:je), stress_lee_v(is:ie,js:je)
         write(io,err=10) u_bot(is:ie,js:je), v_bot(is:ie,js:je), u0_bot(is:ie,js:je)
         write(io,err=10) E_lee_p(is:ie,js:je,:,tau),E_lee_m(is:ie,js:je,:,tau)  
       endif
...
!=======================================================================
     ...
     if (enable_idemix) then
       if (enable_idemix3) then
          ...
          read(io,err=10) G_s(is:ie,js:je,:,tau), G_s(is:ie,js:je,:,taum1)
          read(io,err=10) F_d(is:ie,js:je,:,tau), F_d(is:ie,js:je,:,taum1)
          read(io,err=10) G_d(is:ie,js:je,:,tau), G_d(is:ie,js:je,:,taum1)
          read(io,err=10) O_s(is:ie,js:je,:,tau), O_s(is:ie,js:je,:,taum1)
          read(io,err=10) P_s(is:ie,js:je,:,tau), P_s(is:ie,js:je,:,taum1)
          read(io,err=10) O_d(is:ie,js:je,:,tau), O_d(is:ie,js:je,:,taum1)
          read(io,err=10) P_d(is:ie,js:je,:,tau), P_d(is:ie,js:je,:,taum1)
       else
          read(io,err=10) E_iw(is:ie,js:je,:,tau), E_iw(is:ie,js:je,:,taum1)
          read(io,err=10) dE_iw(is:ie,js:je,:,tau), dE_iw(is:ie,js:je,:,taum1)
       endif
       if (enable_leewaves) then
         read(io,err=10) flux_lee_tot(is:ie,js:je),inv_fr(is:ie,js:je)
         read(io,err=10) stress_lee_u(is:ie,js:je), stress_lee_v(is:ie,js:je)
         read(io,err=10) u_bot(is:ie,js:je), v_bot(is:ie,js:je), u0_bot(is:ie,js:je)
         read(io,err=10) E_lee_p(is:ie,js:je,:,tau),E_lee_m(is:ie,js:je,:,tau)  
       endif
